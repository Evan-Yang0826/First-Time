...
#define SET_SPI_CS  (PAout(8) = 1)
#define CLR_SPI_CS  (PAout(8) = 0)
#define SPI1_SCK   PBout(15)
#define SPI1_MOSI  PBout(14)
#define SPI1_MISO  PBin(13)
#define SET_RC522RST  PBout(12) = 1
#define CLR_RC522RST  PBout(12) = 0
void InitRc522(void);
